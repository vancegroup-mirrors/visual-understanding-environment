...
public class ScorePanel extends tufts.vue.gui.Widget
{
    /** the text pane **/
    ...
    public ScorePanel(boolean autoAttach) {
        this("ScorePanel", autoAttach);
    }
    
    public ScorePanel(String name, boolean autoAttach)
    {
        super("Score");
    ...
    public void attach(LWComponent c) {
    	if (c == null) {
            ...
            mTextPane.attachProperty(c, LWKey.Score);
        }
    }
    ...
    private void load(LWComponent c) {
        attach(c);
        if (c != null)
            setTypeName(this, c, "Score");
    }

    @Override
    public String toString()
    {
        return "ScorePanel[" + mTextPane + "]";
    }
