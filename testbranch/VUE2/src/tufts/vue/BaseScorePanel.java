...
public class BaseScorePanel extends tufts.vue.gui.Widget
{
    /** the text pane **/
    ...
    public BaseScorePanel(boolean autoAttach) {
        this("BaseScorePanel", autoAttach);
    }
    
    public BaseScorePanel(String name, boolean autoAttach)
    {
        super("BaseScore");
    ...
    public void attach(LWComponent c) {
    	if (c == null) {
            ...
            mTextPane.attachProperty(c, LWKey.BaseScore);
        }
    }
    ...
    private void load(LWComponent c) {
        attach(c);
        if (c != null)
            setTypeName(this, c, "BaseScore");
    }

    @Override
    public String toString()
    {
        return "BaseScorePanel[" + mTextPane + "]";
    }

    public static void main(String args[]) {
        DEBUG.Enabled = DEBUG.EVENTS = true;
        DEBUG.KEYS = true;
        BaseScorePanel p = new BaseScorePanel();
