 ...
 */
public class PublisherNoOsid extends JDialog implements ActionListener,tufts.vue.DublinCoreConstants   {
...
//    private static final org.osid.shared.Type _collectionAssetType =  edu.tufts.vue.dsm.DataSourceTypes.SAKAI_COLLECTION_ASSET_TYPE;    
    ...
    public PublisherNoOsid() {
        super(VUE.getDialogParentAsFrame(),TITLE,true);
        // perform this only when map is saved.
        if(isMapSaved())  {
            
            //logger.setLevel(Level.DEBUG);
            this.fedoraDataSourceType = new Type("sakaiproject.org","repository","contentHosting");
            initialize();
...
//            }
    ...
    private DefaultTreeModel getWorkSpaceTreeModel(edu.tufts.vue.dsm.DataSource dataSource) {
        ...
        try {
            ...
            org.osid.repository.AssetIterator assetIterator = SakaiDemo.getAssets();
            //        repository.getAssetsByType(DataSourceTypes.SAKAI_COLLECTION_ASSET_TYPE);
            logger.debug( "repository is " + "Sakai");
    ...
    class DatasourceListModel extends DefaultListModel {
        ...
        private java.util.List<edu.tufts.vue.dsm.DataSource> getResources() {
        	java.util.List<edu.tufts.vue.dsm.DataSource> list = new java.util.ArrayList<edu.tufts.vue.dsm.DataSource>();
        	edu.tufts.vue.dsm.impl.VueDataSource vds = new edu.tufts.vue.dsm.impl.VueDataSource();
        	Properties properties = new Properties();
        	vds.setOsidName("Sakai");
        	vds.setProviderDisplayName("Sakai");
        	vds.setRepositoryDisplayName("Sakai");
        	properties.put(new String("providerDisplayName"), new String("Sakai"));
        /*	try {
				vds.setConfiguration(properties);
